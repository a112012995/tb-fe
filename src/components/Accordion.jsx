...
const OrderTerms = () => {
	...
	return (
		<div className="flex justify-center text-black">
			<div className="card card-large w-1/2 bg-[#F6F6F6] " style={{ width: '1000px' }}>
				<div className="text-2xl font-medium">Kebijakan</div>
				<div className="card-body">
					<div className="bg-white join join-vertical w-full shadow-xl">
						<div className={`collapse collapse-arrow join-item ${activeCollapse === 1 ? 'border' : ''}`}>
							<input type="radio" name="my-accordion-4" checked={activeCollapse === 1} onChange={() => handleCollapseClick(1)} />
							<div className="collapse-title text-xl font-medium ">Kampanye Stop TB</div>
						...
						<div className={`collapse collapse-arrow join-item ${activeCollapse === 2 ? 'border' : ''}`}>
							<input type="radio" name="my-accordion-4" checked={activeCollapse === 2} onChange={() => handleCollapseClick(2)} />
							<div className="collapse-title text-xl font-medium">Edukasi Tentang TB</div>
							<div className="collapse-content">
						...
						<div className={`collapse collapse-arrow join-item ${activeCollapse === 4 ? 'border' : ''}`}>
							<input type="radio" name="my-accordion-4" checked={activeCollapse === 4} onChange={() => handleCollapseClick(4)} />
							<div className="collapse-title text-xl font-medium">Pemeriksaan TB Resistensi Obat</div>
							<div className="collapse-content">
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia maiores in minima tempora rem earum veniam aliquid, ad soluta, placeat optio. Obcaecati esse at nulla quia architecto aspernatur, voluptatibus ab.</p>
							</div>
						</div>
