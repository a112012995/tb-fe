	...
	return (
		<div className="mt-[105px] px-[150px]" id="artikel">
			<div className="flex flex-row">
				...
				<h6 className="mt-1 ml-1 text-[22px] font-medium">- Informasi Seputar TBC</h6>
			</div>
			<div className="flex flex-row space-x-[75px] mt-6 mb-5">
				<a href="https://tbindonesia.or.id/waspada-dengan-bakteri-penyebab-tuberkulosis/" target="_blank">
					<div className="card w-[353px] h-[260px] rounded-2xl bg-white shadow-md">
						...
						<div className=" mt-5 border-b-2">
							<p className="ml-[30px] w-[228px] mb-2 text-sm font-semibold">Waspada dengan Bakteri Penyebab Tuberkulosis!</p>
						</div>
						<p className="ml-[30px] my-4 text-sm font-extralight ">26 Mei 2023</p>
					</div>
				</a>
				<a href="https://tbindonesia.or.id/tuberkulosis-pada-kehamilan" target="_blank">
					<div className="card w-[353px] h-[260px] rounded-2xl bg-white shadow-md">
						<img src={img2} className="h-[141px] rounded-t-2xl" alt="" />
						<div className=" mt-5 border-b-2">
							<p className="ml-[30px] w-[228px] mb-7 text-sm font-semibold">Tuberkulosis pada Kehamilan</p>
						</div>
						<p className="ml-[30px] my-4 text-sm font-extralight ">26 Mei 2023</p>
					</div>
				</a>
				<a href="https://tbindonesia.or.id/apakah-tbc-dapat-kambuh-kembali" target="_blank">
					<div className="card w-[353px] h-[260px] rounded-2xl bg-white shadow-md">
						<img src={img3} className="h-[141px] rounded-t-2xl" alt="" />
						<div className=" mt-5 border-b-2">
							<p className="ml-[30px] w-[228px] mb-2 text-sm font-semibold">Apakah TBC dapat Kambuh Kembali?</p>
						</div>
						<p className="ml-[30px] my-4 text-sm font-extralight ">26 Mei 2023</p>
					</div>
				</a>
