    ...
    <div className="relative bg-white">
      ...
      <div className="relative mt-18 mb-5">
        <div className="relative w-170 px-40">
          <div className="py-12">
            <div className="text-3xl px-10 font-bold text-black">Tambah Akun</div>
          </div>
            ...
            <form class="w-full max-w-md">
              ...
              <div className="md:flex md:items-center pt-9">
                ...
                <div className="md:w-2/3 flex justify-end">
                  <button className="shadow w-24 bg-white  text-black font-bold py-2 px-4 mr-4" type="button" style={{ borderRadius: "20px", outline: "2px solid black" }}>
                    Batal
                  </button>
                  <button className="shadow w-24 bg-black focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4" type="button" style={{ borderRadius: "20px" }}>
                    Tambah
                  </button>
                </div>
              </div>
