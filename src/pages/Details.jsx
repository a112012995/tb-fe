			...
			<div className="px-20 pt-12 pb-9 bg-[#213555] text-white">
				<div className="navbar ">
					...
					<div className="navbar-end gap-12">
						<a href="/dashboard" className="text-2xl font-semibold scroll-smooth">
							Home
						</a>
						<button>
						...
						<div>
							<div className="stats bg-[#FFFFFF] ">
								...
								<div className="stat">
									<div className="flex">
										<div className="flex-col text-center  pt-2">
											<div className="stat-value text-black font-bold text-5xl">80</div>
											<div className="stat-title text-black text-lg">Penduduk Terkena TBC</div>
										</div>
										<div className="text-warning">
											<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current">
												<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
								...
								<div className="stat">
									<div className="flex">
										<div className="flex-col text-center  pt-2">
											<div className="stat-value text-black font-bold text-5xl">20</div>
								...
								<div className="stat">
									<div className="flex">
										<div className="flex-col text-center  pt-2">
											<div className="stat-value text-black font-bold text-5xl">40</div>
